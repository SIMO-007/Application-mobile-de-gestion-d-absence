...
import 'package:project/espace_prof.dart';
import 'dart:convert';
class LoginProfPage extends StatefulWidget {
  @override
  _LoginProfPageState createState() => _LoginProfPageState();
}

class _LoginProfPageState extends State<LoginProfPage> {
  ...
  Future<void> login() async {
    ...
    var url = Uri.parse('http://192.168.11.103/flutter/api/login_prof.php'); // Updated code
      ...
      try {
        ...
        if (jsonResponse.containsKey('id_user')) {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => EspaceProfPage(user_data : jsonResponse)),
          );
        } else {
